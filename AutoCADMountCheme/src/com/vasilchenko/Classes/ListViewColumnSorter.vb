    ...
    Public Class ListViewColumnSorter
        ...
        Public Function Compare(ByVal x As Object, ByVal y As Object) As Integer Implements IComparer.Compare
            ...
            If _mSortOrder = SortOrder.Ascending Then
                ...
                ElseIf IsNumeric(AdditionalFunctionsModule.GetFirstNumericFromString(stringX)) And IsNumeric(AdditionalFunctionsModule.GetFirstNumericFromString(stringY)) Then
                    Return (Val(stringX).CompareTo(Val(stringY)))
                Else
